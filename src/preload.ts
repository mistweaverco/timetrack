...
contextBridge.exposeInMainWorld('electron', {
  addProject: (name) => ipcRenderer.invoke('addProject', name).then(result => result),
  editProject: (opts) => ipcRenderer.invoke('editProject', opts).then(result => result),
  deleteProject: (name) => ipcRenderer.invoke('deleteProject', name).then(result => result),
  ...
  getTaskDefinitions: (projectName) => ipcRenderer.invoke('getTaskDefinitions', projectName).then(result => result),
  ...
  getTasks: (projectName) => ipcRenderer.invoke('getTasks', projectName).then(result => result),
