...
contextBridge.exposeInMainWorld('electron', {
  ...
  startActiveTask: (id: string) =>
    ipcRenderer.invoke('startActiveTask', id).then(result => result),
  pauseActiveTask: (id: string) =>
    ipcRenderer.invoke('pauseActiveTask', id).then(result => result),
  stopActiveTask: (id: string) =>
    ipcRenderer.invoke('stopActiveTask', id).then(result => result),
